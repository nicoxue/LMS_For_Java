<%-- 
    Document   : login
    Created on : 14-Apr-2015, 2:57:04 PM
...
<html>    
    <head>
        ...
        <script language="javascript">
            function check(form) {
                if (form.name.value == "") {
                    alert("Please enter the administation name!");
                    form.name.focus();
                    return false;
                }
                if (form.pwd.value == "") {
                                                                            ...
                                                                            <form name="form1" method="post" action="manager.do?action=login">
                                                                                <table width="100%"  border="0" cellpadding="0" cellspacing="0" bordercolorlight="#FFFFFF" bordercolordark="#D2E3E6">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="10%">Administrator Name：</td>
                                                                                        <td width="31%">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td height="30">&nbsp;</td>
                                                                                        <td colspan="2" align="center"><input name="Submit" type="submit" class="btn_grey" value="Submit" onClick="return check(form1)">
                                                                                            &nbsp;
